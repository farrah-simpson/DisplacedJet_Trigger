...
config.General.requestName = 'DisplacedJets_Run2023D_PromptReco_v2_MC_trigger_dis'
...
config.Data.outputDatasetTag = 'DisplacedJets_Run2023D_miniAOD_v2_MC_trigger_dis'

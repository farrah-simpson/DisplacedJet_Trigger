...
config.General.requestName = 'DisplacedJets_Run2023D_PromptReco_v1_MC_trigger_inc'
...
config.Data.outputDatasetTag = 'DisplacedJets_Run2023D_miniAOD_v1_MC_trigger_inc'

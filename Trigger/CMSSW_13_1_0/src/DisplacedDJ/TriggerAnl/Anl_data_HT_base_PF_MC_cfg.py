...
process.IsoMufilter = cms.EDFilter("HLTHighLevel", 
    ...
    HLTPaths = cms.vstring("HLT_HT240_L1SingleLLPJet_DisplacedDijet40_Inclusive1PtrkShortSig5_v*"),
...
process.TriggerNtuple = cms.EDAnalyzer('TriggerAnlPF_miniAOD_MC'
     ...
     , trigHTFilter = cms.InputTag('hltHT240', '', 'HLT')#('hltCaloJetCollection40Filter', '', 'HLT' )
     , trigJetFilter = cms.InputTag('hltDoubleCentralCaloJetpt40', '', 'HLT')
     , trigPromptJetFilter = cms.InputTag('hltL4PromptDisplacedDijetFullTracksHLTCaloJetTagFilterLowPt1PtrkShortSig5', '', 'HLT')

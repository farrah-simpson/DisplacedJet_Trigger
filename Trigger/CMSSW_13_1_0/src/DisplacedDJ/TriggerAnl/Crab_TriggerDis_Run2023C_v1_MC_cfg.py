...
config.General.requestName = 'DisplacedJets_Run2023C_PromptReco_v1_MC_trigger_dis'
...
config.Data.outputDatasetTag = 'DisplacedJets_Run2023C_miniAOD_v1_MC_trigger_dis'

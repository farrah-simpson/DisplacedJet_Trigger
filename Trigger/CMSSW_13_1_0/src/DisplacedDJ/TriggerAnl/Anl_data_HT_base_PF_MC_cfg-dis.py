...
process.IsoMufilter = cms.EDFilter("HLTHighLevel", 
    ...
    HLTPaths = cms.vstring("HLT_HT200_L1SingleLLPJet_DisplacedDijet40_DisplacedTrack_v*"),
...
process.TriggerNtuple = cms.EDAnalyzer('TriggerAnlPF_miniAOD_MC'
     ...
     , trigHTFilter = cms.InputTag('hltHT200', '', 'HLT')
     ...
     , trigDisplacedJetFilter = cms.InputTag('hltL4DisplacedDijetFullTracksHLTCaloJetTagFilterLowPt', '', 'HLT')#hltDisplacedHLTCaloJetCollectionProducerLowPt1PtrkShortSig5', '', 'HLT')

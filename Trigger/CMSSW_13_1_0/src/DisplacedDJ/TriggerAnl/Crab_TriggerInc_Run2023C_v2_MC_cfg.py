...
config.General.requestName = 'DisplacedJets_Run2023C_PromptReco_v2_MC_trigger_inc'
...
config.Data.outputDatasetTag = 'DisplacedJets_Run2023C_miniAOD_v2_MC_trigger_inc'

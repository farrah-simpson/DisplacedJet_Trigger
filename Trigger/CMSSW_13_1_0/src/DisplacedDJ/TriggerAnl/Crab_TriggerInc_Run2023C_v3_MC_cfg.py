...
config.General.requestName = 'DisplacedJets_Run2023C_PromptReco_v3_MC_trigger_inc'
config.General.workArea = 'crab_projects'
config.General.transferOutputs = True
config.General.transferLogs = False

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'Anl_data_HT_base_PF_MC_cfg-inc.py'
...
config.Data.outputDatasetTag = 'DisplacedJets_Run2023C_miniAOD_v3_MC_trigger_inc'
